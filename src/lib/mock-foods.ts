...
export const MOCK_FOODS: FoodItem[] = [
  food(171077, "Chicken, broilers or fryers, breast, meat only, cooked, grilled", "SR Legacy", {
    calories: 165,
    protein: 31,
    fat: 3.6,
    carbs: 0,
  ...
  food(170567, "Egg, whole, cooked, scrambled", "SR Legacy", {
    calories: 149,
    protein: 9.99,
    fat: 11,
    carbs: 1.61,
  ...
  food(168462, "Bananas, raw", "SR Legacy", {
    calories: 89,
    protein: 1.09,
    fat: 0.33,
    carbs: 22.84,
  ...
  food(168421, "Oats, regular and quick, unenriched, cooked with water", "SR Legacy", {
    calories: 71,
    protein: 2.54,
    fat: 1.52,
    carbs: 12,
  ...
  food(170457, "Salmon, Atlantic, farmed, cooked, dry heat", "SR Legacy", {
    calories: 206,
    protein: 22.1,
    fat: 12.35,
    carbs: 0,
  ...
  food(173944, "Cheese, cheddar", "SR Legacy", {
    calories: 403,
    protein: 22.87,
    fat: 33.31,
    carbs: 3.37,
  ...
  food(167765, "Yogurt, Greek, plain, nonfat", "SR Legacy", {
    calories: 59,
    protein: 10.19,
    fat: 0.39,
    carbs: 3.6,
  ...
  food(168203, "Almonds, raw", "SR Legacy", {
    calories: 579,
    protein: 21.15,
    fat: 49.93,
    carbs: 21.55,
  ...
  food(170110, "Sweet potato, cooked, baked in skin, without salt", "SR Legacy", {
    calories: 90,
    protein: 2.01,
    fat: 0.15,
    carbs: 20.71,
  ...
  food(169414, "Avocado, raw, all commercial varieties", "SR Legacy", {
    calories: 160,
    protein: 2,
    fat: 14.66,
    carbs: 8.53,
